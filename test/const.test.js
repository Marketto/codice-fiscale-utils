...
describe('CodiceFiscaleUtils:Const', () => {
    describe('validator', () => {
        ...
        describe('VOWEL_LIST', () => {
            const vowelMatcher = new RegExp(`^[${VALIDATOR.VOWEL_LIST}]$`, 'i');
        ...
        describe('OMOCODE_NUMBER_LIST', () => {
            const omocodeMatcher = new RegExp(`^[${VALIDATOR.OMOCODE_NUMBER_LIST}]$`, 'i');
        ...
        describe('OMOCODE_NON_ZERO_NUMBER_LIST', () => {
            const omocodeMatcher = new RegExp(`^[${VALIDATOR.OMOCODE_NON_ZERO_NUMBER_LIST}]$`, 'i');
        ...
        describe('OMOCODE_ZERO_LIST', () => {
            const omocodeMatcher = new RegExp(`^[${VALIDATOR.OMOCODE_ZERO_LIST}]$`, 'i');
        ...
        describe('MONTH_LIST', () => {
            const monthCodeMatcher = new RegExp(`^[${VALIDATOR.MONTH_LIST}]$`, 'i');
        ...
        describe('MONTH_30DAYS_LIST', () => {
            const monthCodeMatcher = new RegExp(`^[${VALIDATOR.MONTH_30DAYS_LIST}]$`, 'i');
        ...
        describe('MONTH_31DAYS_LIST', () => {
            const monthCodeMatcher = new RegExp(`^[${VALIDATOR.MONTH_31DAYS_LIST}]$`, 'i');
        ...
        describe('LEAP_YEAR_MATCHER', () => {
            const yearMatcher = new RegExp(`^${VALIDATOR.LEAP_YEAR_MATCHER}$`, 'i');
        ...
        describe('PARTIAL_CF', () => {
            const partialCFMatcher = new RegExp(`^(?:${VALIDATOR.PARTIAL_CF})$`, 'i');
            it('Should match partial valid CF', () => {
